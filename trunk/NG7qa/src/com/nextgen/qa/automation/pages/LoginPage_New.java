...
import test.Pages.SeleneseTestCase;
import test.Pages.chromeDriver;
...
public class LoginPage_New {
	...
	@FindBy(how = How.CSS, using = "input[type='test'][id='email_address']")
    public WebElement emailField;
	
	@FindBy(how = How.CSS, using = "input[type='password'][id='password']")
    public WebElement passwordField;
	
	@FindBy(how = How.CSS, using = "span[class='add-on'] input[type='checkbox']")
    public WebElement passwordField;
	
	public class LoginPage_New extends SeleneseTestCase {
