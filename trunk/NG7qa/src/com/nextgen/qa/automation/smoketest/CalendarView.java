...
public class CalendarView extends NG7TestCase {
		  
		@Test
		public static void test() throws Exception {
			NG7TestCase.testName = "CalendarView";	
			...
			for (int i = 1; i <= localStressLoop; i++){
				...
				Artifact.VerifyWriteToArtifactS(artifact, iterationStamp+"Click ERAs tab", currStepResult);
				prevStepResult = currStepResult;
