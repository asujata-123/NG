...
import com.nextgen.qa.automation.toolbox.NG7TestCase;
	...
	public class CheckEligibility_SelectedPlan extends NG7TestCase {
		  
		@Test
		public static void test() throws Exception {
			NG7TestCase.testName = "CheckEligibility_SelectedPlan";	
			...
			String preReq_checkEligibilitySlidingModal = currStepResult;
				...
				//System.out.println("checkEligibilitySlidingModal");*/
				...
				//if (checkEligibilitySlidingModal != null)
					//checkEligibilitySlidingModal = "Pass";
				
				
				
				// test step
			/*	List<WebElement> Checkboxselect = GeneralMethods.FindElementsInObjHierarchy(modal, "div[class='slidingModal active-sliding-modal'");
				System.out.println("Checkboxselect");
				prevStepResult = currStepResult;
				currStepResult = !prevStepResult.equals("Pass") ? "Blocked" :
					GeneralMethods.checkIsNotEmpty(Checkboxselect) ? "Pass" : "Fail";
		...
		/*currStepResult = (prevStepResult.equals("Pass") == false) ? "Blocked" :
			//currStepResult = preReq_CheckEligibilityModalopen.equals("Pass") == false ? "Blocked" :
				//GeneralMethods.ClickButton(chargesLink) ? "Pass" : "Fail";
				GeneralMethods.ClickButton(pdb.findVisibleElement(pdb.openPatientDashboard, pdb.SelectAllCss)) ? "Pass" : "Fail";
			...
			prevStepResult = currStepResult;*/	
				...
				//currStepResult = preReq_checkEligibilitySlidingModal.equals("Pass") == false ? "Blocked" :
					//GeneralMethods.ClickButton(chargesLink) ? "Pass" : "Fail";
					GeneralMethods.ClickButton(pdb.findVisibleElement(pdb.checkEligibilitySlidingModal, pdb.SelectAllCss)) ? "Pass" : "Fail";
				Artifact.VerifyWriteToArtifactS(artifact, iterationStamp+"Click Financial grid Charges link", currStepResult);
				prevStepResult = currStepResult;*/	
				...
				/*currStepResult = (prevStepResult.equals("Pass") == false) ? "Blocked" :
					//currStepResult = preReq_checkEligibilitySlidingModal.equals("Pass") == false ? "Blocked" :
						//GeneralMethods.ClickButton(chargesLink) ? "Pass" : "Fail";
						GeneralMethods.ClickButton(pdb.findVisibleElement(pdb.checkeligibilitymodal, pdb.SelectAllCss)) ? "Pass" : "Fail";
					Artifact.VerifyWriteToArtifactS(artifact, iterationStamp+"Click Financial grid Charges link", currStepResult);
					prevStepResult = currStepResult;*/	
				...
				currStepResult = preReq_checkEligibilitySlidingModal.equals("Pass") == false ? "Blocked" :
					...
					pdb.clickElement(pdb.SelectplanCheckbox, "Select plan CheckBox") ? "Pass" : "Fail";
			...
			//String preReq_checkEligibilitySlidingModal = currStepResult;
				...
				//currStepResult = preReq_patientTabOpened.equals("Pass") == false ? "Blocked" :
				/*currStepResult = (preReq_CheckButtonEnabled.equals("Pass") == false) ? "Blocked" :
					pdb.clickButton2("Check", "Check") ? "Pass" : "Fail";
					//pdb.clickButton("Check Eligibility", "Insurance Tab Check Eligibility") ? "Pass" : "Fail";
					//GeneralMethods.clickButton(pdb.findVisibleElement(pdb.activeeligibilitymodal, pdb.modalFooterButtons)) ? "Pass" : "Fail"; // MGB 3/9/2015 updated to use css
				Artifact.VerifyWriteToArtifactS(artifact, iterationStamp+"Check Eligibility Button", currStepResult);
				prevStepResult = currStepResult;
			//String preReq_checkEligibilitySlidingModal = currStepResult;*/
					...
					//currStepResult = (prevStepResult.equals("Pass") == false) ? "Blocked" :
						/*currStepResult = preReq_checkEligibilitySlidingModal.equals("Pass") == false ? "Blocked" :
							//GeneralMethods.ClickButton(chargesLink) ? "Pass" : "Fail";
						pdb.checkElementIsVisible(pdb.activeeligibilitymodal, "activeeligibilitymodal") ? "Pass" : "Fail";	
						
						pdb.checkElementIsVisible(pdb.findVisibleElement(pdb.modalContentCheckboxes, pdb.SelectAllCss) ? "Pass" : "Fail";
					//(pdb.InsuranceCheckBox)? "Pass" : "Fail";
					//	pdb.checkElementIsVisible(pdb.findVisibleElement(pdb.InsuranceCheckBox, pdb.SelectAll)) ? "Pass" : "Fail";
						pdb.checkElementIsVisible(pdb.findVisibleElement(pdb.activeeligibilitymodal, pdb.SelectAllCheckbox) ? "Pass" : "Fail";
					//pdb.checkElementIsVisible(pdb.findVisibleElement(pdb.activeeligibilitymodal, pdb.InsuranceCheckBox)) ? "Pass" : "Fail";
						Artifact.VerifyWriteToArtifactS(artifact, iterationStamp+"Click Financial grid Charges link", currStepResult);
						prevStepResult = currStepResult;	
						GeneralMethods.clickButton(pdb.findVisibleElement(pdb.activeeligibilitymodal, pdb.SelectAllCss)) ? "Pass" : "Fail";*/
